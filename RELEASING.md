...
The publisher then compares the registry `dist.integrity` value with that complete local tarball, so a resumed release cannot accept different README or runtime bytes under the same version.
