...
- Audited corpus SHA-256: `b9b43d7dd088a680fb1289260a78861e864b7e15f1b426f6f6825d4407f83db1`
...
- Five-token shingles shared by at least two recipes: 53
...
| --- | --- | --- | ---: | --- | --- | --- | --- |
| document-api | synchronize-documentation | workflow-steps | 0.035 | `dddddd03f039d4d2a789eba171e99ad27debfcbebdbc05593da3680e7985168e` | below threshold |  |  |
| document-api | triage-issues | workflow-steps | 0.020 | `0dba034b336c056db05211ea44ad1bc7c68997f68e3038750d6f465b8de05912` | below threshold |  |  |
| synchronize-documentation | triage-issues | workflow-steps | 0.015 | `4e8bf53466d4c59cec088a70a42cdae0a145e8956975696a35aa926d27c35730` | below threshold |  |  |
...
| document-api | incident-postmortem | workflow-steps | 0.009 | `15f468886cf4abdcc3df46003030e5ea1973e5b9f72e4b8063e702aa33419239` | below threshold |  |  |
...
| incident-postmortem | triage-issues | workflow-steps | 0.007 | `79082417a98b679dc45078b3869abb49edc7b60f50dc4c79088a6f2648ee663c` | below threshold |  |  |
| incident-postmortem | synchronize-documentation | workflow-steps | 0.006 | `50e203fc00166810cbfe131a22839191d8ed339cfb0e25a858031ec2a962aaf8` | below threshold |  |  |
...
| advance when every applicable approval | 3 | document-api, synchronize-documentation, triage-issues | workflow-steps |
...
| approval recorded explicitly non-applicable stop | 3 | document-api, synchronize-documentation, triage-issues | workflow-steps |
...
| when every applicable approval recorded | 3 | document-api, synchronize-documentation, triage-issues | workflow-steps |
...
| assumptions limitations traceability complete only | 2 | incident-postmortem, triage-issues | workflow-steps |
...
| every completion criterion maps artifact | 2 | document-api, incident-postmortem | workflow-steps |
| every material path version command | 2 | debug-failing-ci, reproduce-bug | checklist-controls |
| explicitly non-applicable stop publication while | 2 | document-api, synchronize-documentation | workflow-steps |
