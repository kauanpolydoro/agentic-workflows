...
It applies to recipe metadata, the canonical workflow, execution checklist, individual README, examples, adapter declarations, generated catalog content, and verification claims.

The intended reviewers are recipe authors, repository maintainers, domain reviewers, and adapter maintainers.
