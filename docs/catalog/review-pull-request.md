...
description: "Review a pull request against a frozen diff and its stated intent, producing findings traceable to evidence, checks that actually ran, and a merge verdict you can defend."
---
