...
description: "Split one change-coupled module into cohesive boundaries, one reversible checkpoint at a time, preserving its evidenced public contract and capturing the work in a Markdown refactor delivery record."
---
...
The [synthetic input](#complete-example-input) supplies an immutable scope, a contract map, implementation slices, checkpoint results, and rollback evidence for a reporting module.
