...
description: "Turn manifests, lockfiles, and dated advisories into a reproducible dependency inventory, a ranked finding register, and a plan that keeps affected versions separate from actual reachability."
---
