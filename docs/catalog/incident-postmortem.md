...
description: "Build a bounded, blameless incident learning record from retained evidence, covering impact, timeline, causal confidence, organizational conditions, and corrective actions that can be verified."
---
...
See the [synthetic input](#complete-example-input) and the [expected output](#complete-expected-output).
