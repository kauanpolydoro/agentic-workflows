...
- [Run an autonomous GitHub issue resolution campaign](./resolve-github-issues) - Define a finite autonomous campaign that resolves the maximum safe number of authorized GitHub issues without mid-run input and retains evidence for every terminal outcome.
