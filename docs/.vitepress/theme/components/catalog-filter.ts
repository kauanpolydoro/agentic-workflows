...
import type { RegisteredAdapterId } from "@agentic-workflows/core/adapter-registry";
import { adapterRegistry, deriveAdapterSupport } from "@agentic-workflows/core/adapter-registry";
