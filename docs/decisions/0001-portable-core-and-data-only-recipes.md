...
Maintain a small `@agentic-workflows/core` package as the only owner of recipe and manifest schemas, catalog loading, path controls, hashing, and adapter serialization.
