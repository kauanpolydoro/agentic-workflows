...
Execute o exemplo a seguir para Codex a partir da raiz de um projeto existente que ainda não tenha configuração do AWF nem o pacote `review-pull-request` instalado:
...
Se `.agentic-workflows/config.yml` já existir, não execute `awf init` novamente; inspecione as configurações mantidas com `awf doctor` e continue com elas.
Se `review-pull-request` já estiver instalado, use `awf update review-pull-request --dry-run --show-content` em vez de instalá-lo outra vez.
Use `awf init --force` somente depois de fazer backup e revisar uma configuração existente que você queira substituir intencionalmente.
...
A receita de referência `write-release-notes` inclui uma [entrada sintética e autocontida](https://kauanpolydoro.github.io/agentic-workflows/catalog/write-release-notes#complete-example-input) e o [artefato completo de notas de versão esperado](https://kauanpolydoro.github.io/agentic-workflows/catalog/write-release-notes#complete-expected-output).
...
Consulte o [registro das avaliações de referência](https://kauanpolydoro.github.io/agentic-workflows/launch/reference-evaluations) para ver a rastreabilidade das afirmações e o limite explícito da verificação.
...
O [guia de contribuição](https://github.com/kauanpolydoro/agentic-workflows/blob/main/CONTRIBUTING.md) é a fonte oficial para a suíte completa de validação exigida antes da entrega.
...
| Contribuir com alterações | [CONTRIBUTING.md](https://github.com/kauanpolydoro/agentic-workflows/blob/main/CONTRIBUTING.md) |
| Reportar uma vulnerabilidade de forma privada | [SECURITY.md](https://github.com/kauanpolydoro/agentic-workflows/blob/main/SECURITY.md) |
| Ver entregas e planos | [CHANGELOG.md](https://github.com/kauanpolydoro/agentic-workflows/blob/main/CHANGELOG.md) e [ROADMAP.md](https://github.com/kauanpolydoro/agentic-workflows/blob/main/ROADMAP.md) |
...
Revise uma receita antes de pedir que um agente a siga e use o processo privado em [SECURITY.md](https://github.com/kauanpolydoro/agentic-workflows/blob/main/SECURITY.md) para reportar vulnerabilidades.
