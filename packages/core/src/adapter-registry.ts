...
export const adapterRegistry = {
  ...
  "claude-code": externalAdapter(
    ...
    },
    {
      consumerParse: {
        status: "passing",
        evidence: ["verification/review-pull-request/claude-code-20260715-final-execution.yml"],
      },
      externalExecution: {
        status: "passing",
        evidence: ["verification/review-pull-request/claude-code-20260715-final-execution.yml"],
  ...
  codex: externalAdapter(
    ...
    },
    {
      consumerParse: {
        status: "passing",
        evidence: ["verification/review-pull-request/codex-20260715-final-execution.yml"],
      },
      externalExecution: {
        status: "passing",
        evidence: ["verification/review-pull-request/codex-20260715-final-execution.yml"],
