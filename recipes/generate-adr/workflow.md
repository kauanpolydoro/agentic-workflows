...
The [synthetic input](examples/input.md) supplies a stable validation-ownership question, repository facts, common criteria, alternatives, related-decision search, and explicit architecture-owner approval.
